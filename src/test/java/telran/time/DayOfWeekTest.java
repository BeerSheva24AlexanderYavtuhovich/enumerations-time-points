...
public class DayOfWeekTest {
    ...
    private static final String NON_ISRAEL_WEEKEND = "Weekend day but not in Israeal";
    ...
    void enumExistingMethodsTest() {
        DayOfWeek[] expected = { DayOfWeek.MON, DayOfWeek.TUE, DayOfWeek.WED, DayOfWeek.THU, DayOfWeek.FRI,
